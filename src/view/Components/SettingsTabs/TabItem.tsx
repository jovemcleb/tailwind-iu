...
export function TabItem({ title, value, isSelected = false }: TabItemProps) {
  return (
    ...
    >
      <span className="whitespace-nowrap rounded group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4 dark:text-zinc-400">
        {title}
      </span>
      {isSelected && (
        <motion.div
